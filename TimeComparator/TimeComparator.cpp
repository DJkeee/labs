...
public:
    ...
    void TestOfArrays(int size) {
        ...
        // Измерение времени вставки для ArraySequence
        ...
        // Измерение времени вставки для DynamicArray
    ...
    void TestOfLists(int size) {
        ...
        // Измерение времени вставки для ListSequence
        ...
        // Измерение времени вставки для RawList
